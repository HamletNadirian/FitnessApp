...
object AllExercises {
    ...
    val workoutExercises: Map<WorkoutKey, List<Exercise>> = mapOf(
            WorkoutKey(1, 1) to listOf(
                Exercise("Dead bug", 3, R.drawable.deadbug, "Lie on your back, lift arms and legs, and alternate extending opposite arm and leg while keeping core engaged."),
                Exercise("Dumbbell-Curl", 3, R.drawable.dumbbellcurl, "Stand with dumbbells in hands, curl weights toward shoulders, keeping elbows close to body."),
                Exercise("Dumbbell-Lateral-Raise", 3, R.drawable.dumbbelllateralraise, "Hold dumbbells at sides, raise arms to shoulder height, keeping elbows slightly bent."),
                Exercise("Lat-Pull down", 3, R.drawable.latpulldown, "Pull bar down to chest while seated, engaging back muscles, keeping core tight.")
            ),
            WorkoutKey(2, 1) to listOf(
                Exercise("Leg-Curl", 3, R.drawable.legurl, "Lie face down on machine, curl legs toward glutes, contracting hamstrings."),
                Exercise("LEG-EXTENSION", 3, R.drawable.legextension, "Sit on machine, extend legs to straighten knees, engaging quadriceps."),
                Exercise("Lever-Shoulder-Press", 3, R.drawable.levershoulderpress, "Push handles upward from shoulder height while seated, engaging deltoids."),
                Exercise("Pec-Deck-Fly", 3, R.drawable.pecdeckfly, "Sit on machine, bring handles together in front of chest, engaging pectorals.")
            ),
            WorkoutKey(3, 1) to listOf(
                Exercise("Lying-Chest-Press-Machine", 3, R.drawable.lyingchestpressmachine, "Lie on machine, push handles upward, engaging chest and triceps."),
                Exercise("Pec-Deck-Fly", 3, R.drawable.pecdeckfly, "Sit on machine, bring handles together in front of chest, engaging pectorals."),
                Exercise("Pushdown", 3, R.drawable.pushdown, "Stand at cable machine, push bar down to thighs, engaging triceps."),
                Exercise("Lat-Pull down", 3, R.drawable.latpulldown, "Pull bar down to chest while seated, engaging back muscles, keeping core tight.")
            ),
            WorkoutKey(4, 1) to listOf(
                Exercise("Seated-Row-Machine", 3, R.drawable.seatedrowmachine, "Sit on machine, pull handles toward torso, engaging back and biceps."),
                Exercise("Pec-Deck-Fly", 3, R.drawable.pecdeckfly, "Sit on machine, bring handles together in front of chest, engaging pectorals."),
                Exercise("Gluteal bridge", 3, R.drawable.gluteal_bridge, "Lie on back, knees bent, lift hips toward ceiling, engaging glutes."),
                Exercise("LEG-EXTENSION", 3, R.drawable.legextension, "Sit on machine, extend legs to straighten knees, engaging quadriceps.")
            ),
